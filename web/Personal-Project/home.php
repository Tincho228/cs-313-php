...
<body>
    <div class="wrapper-body">
        <header>
            <div class="container-fluid container-hero-image">
                ...
                <div class="jumbotron jumbotron-fluid bg-transparent">
                    <div class="container">
                        <h1 class="display-3 text-light">MAFUBA GYM and FITNESS</h1>
        ...
        <main>
            ...
            <section class="about-us">
                ...
                <div class="row">
                    <div class="col-6">
                    <h1>about us</h1>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit quas impedit beatae magnam cupiditate laudantium error veniam placeat nihil sunt.</p>
                    </div>
                    <div class="col-6">
                    <h3>Lorem ipsum dolor sit amet.</h3>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Inventore libero in dignissimos cupiditate aperiam tenetur quae, magni quo pariatur. Doloremque quidem voluptas nemo non corporis, quod possimus culpa inventore reprehenderit?</p>
                    </div>
                    </div>
                </div>
            </section>
        ...
        <footer>
            <div class="container-fluid bg-dark section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <h4 class="text-light"> Location</h4> 
                            <hr class="bg-warning">
                            <p class="text-light"><i class="fa fa-location-arrow" aria-hidden="true"></i> Address</p>
                            <p class="text-light">2563 Utah Street, St. Louis, MO, USA</p> 
                            <p class="text-light"><i class="fas fa-mail-bulk    "></i> Email</p>
                            <p class="text-light">info@mafubafitness.com</p> 
                            <p class="text-light"><i class="fa fa-phone" aria-hidden="true"></i> Phone number</p>
                        ...
                        <div class="col">
                            ...
                            <h2 class="text-light display-3 text-center">MAFUBA GYM & FITNESS</h2>    
